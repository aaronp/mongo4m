...
object CollectionSettings {
  ...
  def forMongoConfig(mongoConfig: Config, collectionName: String): CollectionSettings = {
    val dbConfig: MongoConnect.DatabaseConfig = MongoConnect.DatabaseConfig(mongoConfig, collectionName)
